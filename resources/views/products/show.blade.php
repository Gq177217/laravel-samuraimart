         ...
         <div class="offset-1 col-10">
             ...
             <div class="row">
                ...
                <div class="offset-md-5 col-md-5">
                    <h3 class="review-score-color">{{ str_repeat('⭐️', $review->score) }}</h3>
              ...
              <div class="row">
                <div class="offset-md-5 col-md-5">
                    <form method="POST" action="{{ route('reviews.store') }}">
                        @csrf
                        <h4>評価</h4>
                        <select name="score" class="form-control m-2 review-score">
                            <option value="5" class="review-score-color">⭐️⭐️⭐️⭐️⭐️</option>
                            <option value="4" class="review-score-color">⭐️⭐️⭐️⭐️</option>
                            <option value="3" class="review-score-color">⭐️⭐️⭐️</option>
                            <option value="2" class="review-score-color">⭐️⭐️</option>
                            <option value="1" class="review-score-color">⭐️</option>
                        </select>
                        <h4>レビュー内容</h4>
                        @error('content')
